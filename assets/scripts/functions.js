...
//     //console.log((check01.checked && item.type == check01.value))

//     allPoducts = allPoducts.filter(item => (check01.checked && item.type == check01.value) || (check02.checked && item.type == check02.value) || (check03.checked && item.type == check03.value) || (check04.checked && item.type == check04.value) || (check05.checked && item.type == check05.value) || (check06.checked && item.type == check06.value))

//     if (check07.checked || check08.checked){
//         allPoducts = allPoducts.filter(item => (check07.checked && item.gender == check07.value) || (check08.checked && item.gender == check08.value));
//     }
//     if (allPoducts.lenght > 0){
//         allPoducts.forEach(allProduct =>{
//             cardContent += `
